...
public class MainActivity extends Activity  implements RadioGroup.OnCheckedChangeListener{
    ...
    public void addListener() {
       /*help.setOnClickListener(new View.OnClickListener() {//帮助按钮的监听部分
       @Override
       public void onClick(View v) {
           System.out.println("帮助部分");
           if(flage)
           {
               helptext.setVisibility(View.VISIBLE);//可见
               helptext.setText(textString);
               flage=false;
           }if(!flage)
           {
               helptext.setVisibility(View.GONE);//不可见
               flage=true;
           }
         }
        });*/
